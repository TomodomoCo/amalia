 ...
 */
 ...
 // MODIFICATIONS FOR AMALIA BY PETER UPFOLD.
...
jQuery.fn.editInPlace = function(options) {
	...
	var settings = {
		...
		saving_text:		"Saving...",
		saving_image:		"",
		default_text:		"[add a title]",
		select_text:		"Choose new value",
		value_required:		null,
		element_id:			"element_id",
		update_value:		"update_value",
		original_html:		"original_html",
		save_button:		'<div id="rename-submit-hold"><button type="submit" name="submit" id="rename-submit"><div class="button-side inplace_save"></div>Submit</button>',
		cancel_button:		'',
		show_buttons:		true,
		on_blur:			null,
		callback:			null,
	...
	return this.each(function(){
		...
		.click(function(){
			...
			if(!editing)
			{
				...
				jQuery(this).siblings('.filename').hide();
				editing = true;
			...
			if(click_count == 1)
			{
				function cancelAction()
				{
					...
					original_element.siblings('.filename').show();
				...
				$("#rename-submit").click(saveAction);
                ...
                //}
             	...
             	// force onblur to cancel event
             	//$("#rename-form").children().blur(cancelAction);
