...
(function() {
	...
	tinymce.PluginManager.requireLangPack('amalia_image');

	tinymce.create('tinymce.plugins.AmaliaImagePlugin', {
		/**
		...
		init : function(ed, url) {
			...
			ed.addCommand('mceAmaliaInsertImage', function() {
				ed.windowManager.open({
					file : url + '/insertimage.php?dir=' + encodeURIComponent(dirlink),
			...
			ed.addButton('amalia_image', {
				title : 'Insert Image',
				cmd : 'mceAmaliaInsertImage',
		...
		getInfo : function() {
			return {
				longname : 'Amalia Image Plugin 2.0',
				author : 'Peter Upfold',
	...
	// Register plugin
	tinymce.PluginManager.add('amalia_image', tinymce.plugins.AmaliaImagePlugin);
})();